                    ...
                    <Navbar collapseOnSelect expand="lg" dark>
                        <Col className="d-flex align-items-center">
                            <NavbarBrand>
                                <NavLink tag={RRNavLink} to="/">
                                     Производство лекарств из готовых веществ
                                </NavLink>
                            </NavbarBrand>
                        </Col>
                        ...
                        <Collapse id="responsive-navbar-nav" navbar isOpen={!collapsed}>
                            <Nav className="mr-auto fs-5 d-flex flex-grow-1 justify-content-end align-items-center" onClick={hideMenu} navbar>
                                <NavItem>
                                    <NavLink tag={RRNavLink} to={"/substances/"}>
                                        Вещества
                                    </NavLink>
                                </NavItem>
                                {is_superuser &&
                                    <NavItem>
                                        <NavLink tag={RRNavLink} to={"/substances-table/"}>
                                            Таблица веществ
                                        </NavLink>
                                    </NavItem>
                                }
                                {is_authenticated ?
                                    <>
                                        <NavItem>
                                            <NavLink tag={RRNavLink} to="/medicines/">
                                                Лекарства
                                            </NavLink>
                                        </NavItem>
                                        <NavItem>
